...
public:
    ...
    cabBooking()
    {
        ...
        allCabs.push_back(new SUV(345678, "Pooja Sharma", locations[rand() % locations.size()], rand() % 2));
        ...
        allCabs.push_back(new SUV(555666, "Aryan Verma", locations[rand() % locations.size()], rand() % 2));
